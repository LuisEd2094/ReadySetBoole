...
impl BooleanOperations {
    ...
    fn to_nnf(&self, node: ExprNode) -> ExprNode {
        match node {
    ...
    fn to_rpn(&self, node: &ExprNode) -> String {
        match node {
...
mod tests {
    ...
    fn test() {
        ...
        assert_eq!(boolean_evaluation.negation_normal_form("AB|C&!"), "A!B!&C!|");

        // No transformation needed
        assert_eq!(boolean_evaluation.negation_normal_form("A!B!&C!|"), "A!B!&C!|");
        assert_eq!(boolean_evaluation.negation_normal_form("A!B!|"), "A!B!|");
        assert_eq!(boolean_evaluation.negation_normal_form("A!B!&"), "A!B!&");
        assert_eq!(boolean_evaluation.negation_normal_form("A!B|"), "A!B|");
        assert_eq!(boolean_evaluation.negation_normal_form("A!B|B!A|&"), "A!B|B!A|&");
    }
}
